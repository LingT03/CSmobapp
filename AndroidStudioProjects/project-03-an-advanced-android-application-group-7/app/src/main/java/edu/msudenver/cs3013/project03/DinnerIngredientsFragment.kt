...
class DinnerIngredientsFragment : Fragment() {
    /** Fragment to display the ingredients for the dinner selection.
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_dinner_ingredients, container, false)
        view.findViewById<Button>(R.id.button_next)?.setOnClickListener(//sets onclick listener
            Navigation.createNavigateOnClickListener(R.id.action_dinnerIngredientsFragment_to_mapsFragment, null) //references action
        )
    ...
    companion object {//creates companion object
        @JvmStatic
        fun newInstance() =
            DinnerIngredientsFragment().apply {
